...
namespace RabbitMQWeb.Watermark.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,PictureName")] Product product,IFormFile Imagefile)
        {
            ...
            if(Imagefile is { Length: > 0 })
            {
                ...
                product.PictureName = randomImageName;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Stock,PictureName")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
